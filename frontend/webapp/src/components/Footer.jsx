  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (error.code === "permission-denied") {
        errorMessage =
          "Unable to subscribe due to permission issues. Please try again later.";
  ...
  return (
    ...
    >
      <div className="w-full py-[10px] lg:px-[140px] lg:pt-[20px] h-auto px-[20px] ">
        ...
        <div className="w-full px-5 py-2 flex flex-col md:lg:flex-row gap-[80px] md:py-[10px] justify-between">
          <BlockComponent
            title={"Quick Links"}
            customBody={
            ...
            customBody={
              <div className="flex flex-col gap-2 pt-3 justify-between">
                ...
                <div className="flex col gap-x-2">
                  ...
                  ></i>
                  <div className="text-[18px]">noreply.sketchify@gmail.com</div>
                </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-row md:flex-col items-center outline outline-2 rounded w-[268px] md:lg:h-[35px] md:lg:w-[350px]">
      ...
      <div className="pt-5 w-full flex flex-col px-3 gap-1 content-center items-center justify-center md:px-[80px] h-auto">
        <div className="order-2 content-center text-[11px] py-2 md:lg:text-[14px] md:lg:order-1">
          2025 © Sketchify.ai. All rights reserved. Privacy Policy | Terms of
          Service | Sitemap
        </div>
      </div>
    </div>
