...
export default function SignIn() {
  ...
  return (
    <div className="mb-[120px]">
      <NextSeo title="Sketchify.ai | Sign In" description="Sign in to Sketchify to start creating and sharing your art." />
      ...
      <div className="flex md:flex-row flex-col justify-between items-center xl:w-[1280px] w-full mx-auto rounded-[20px] bg-white">
        <div className="w-full px-[20px] lg:px-[80px] xl:px-[160px] py-[60px]">
          <h2 className="font-fraunces md:text-7xl text-5xl text-center mb-[20px]">Sign In</h2>

          {/* ✅ Google Sign-In Button */}
          <div className="flex gap-2 items-center">
            <button className="btn w-full flex items-center justify-center gap-2" onClick={handleGoogleSignIn} disabled={loading}>
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <div className="flex items-center justify-between border border-primary rounded-md px-2 h-[42px]">
              ...
              />
              <button className="p-0" onClick={() => togglePasswordVisibility("password")}>
          ...
          {/* ✅ Sign-In Button */}
          <button className="btnRev w-full my-4 md:my-6" onClick={handleEmailSignIn} disabled={loading}>
